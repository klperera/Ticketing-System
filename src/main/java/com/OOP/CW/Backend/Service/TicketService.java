            ...
            if (event.isPresent()) {
                ...
                if (ticketsDetails.getTotalTicketsBySubTickets() <= vendor.get().getPurchasedTickets()) {
                    ...
                    for (int i = 1; i <= ticketsDetails.getEarlyBirdTicket().getNumberOfTickets(); i++) {
                        ...
                        Ticket earlyBirdTicket = new EarlyBirdTicket(event.get(), vendor.get(), event.get().getTicketPool(), ticketsDetails.getEarlyBirdTicket().getDiscount());
                    ...
                    for (int i = 1; i <= ticketsDetails.getGeneralTicket().getNumberOfTickets(); i++) {
                        ...
                        Ticket generalTicket = new GeneralTicket(event.get(),  vendor.get(), event.get().getTicketPool(), ticketsDetails.getGeneralTicket().getDiscount());
                    ...
                    for (int i = 1; i <= ticketsDetails.getLastMinuteTicket().getNumberOfTickets(); i++) {
                        ...
                        Ticket lastMinuteTicket = new LastMinuteTicket(event.get(), vendor.get(), event.get().getTicketPool(), ticketsDetails.getLastMinuteTicket().getDiscount());
